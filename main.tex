...
% TvO: Our definition only checks the condition for any prefix (so participants 1 to any number). Of course, the condition itself can do anything with that prefix; e.g., the condition might be that the first 5 participants and 20 to 30 satisfy something. 
